...
> 完整修订记录见 [`需求文档.md`](需求文档.md) 开头三张「本次修订说明」表。
...
- [需求文档.md](需求文档.md) —— 完整需求、架构决策记录（ADR）、验收清单、风险登记册
- [开源项目链接.md](开源项目链接.md) —— 逐条核实过的开源项目清单
- [skills/](skills/) —— 各 Agent 的能力边界与 System Prompt
